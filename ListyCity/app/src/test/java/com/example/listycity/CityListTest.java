...
public class CityListTest {
    ...
    public void testDeleteCity() {
        ...
        assertTrue(cityList.deleteCity(calgary));

        // Now test exception for a missing city (toronto not in list)
        assertThrows(IllegalArgumentException.class, () -> {
            cityList.deleteCity(toronto);
        });
    }
    ...
    public void testHasCity(){
        ...
        assertFalse(cityList.hasCity((new City("London", "Ontario"))));
    }
